...
<body>
<form id="frm" method="post" action="lg_ok"  name="join" method="post"  target="_self" onsubmit="return chk_frm()">    
        ...
        <h2 align="center"> 로그인을 하쎄용 (๑ơ ₃ ơ)♥ </h2> <br>
        
		♥아이디♥<br> <input type="text" name="id" value=""> <br>
		♥비밀번호♥<br> <input type="password" name="pw" value=""> <br>
		
		<input type="submit" value="✿로그인하기✿" style = "background-color:#FBEFEF">
	<a href="member.jsp"><input type="button" value="✿회원가입하기✿" style = "width:240pt; background-color:#F78181"> </a>
